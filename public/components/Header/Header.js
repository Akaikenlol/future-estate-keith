				...
				<li>
					<div class="dropdown dropdown-hover">
						...
						<ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-md w-52">
							<li><a href="/public/pages/Rent/index.html" class="text-slate-600 active:text-white text-md font-semibold hover:text-purple-500">Rent</a></li>
							<li><a href="/public/pages/Services/index.html" class="text-slate-600 active:text-white text-md font-semibold hover:text-purple-500">Sell</a></li>
						</ul>
					</div>
				</li>
